...
namespace ZGF.Revit.DuplicateViewUtilities
{
    /// <summary>
    /// Utilities that assist duplication of drafting views and schedules into another document.
    /// </summary>
    class DuplicateViewUtils
    {
                                                    ...
                                                    Document toDocument)
        {
            ...
            using (TransactionGroup tg = new TransactionGroup(toDocument, "Import Drafting View(s)"))
            {
                tg.Start();
        ...
        {
            // TEMP - Remove "Viewers"
            ICollection<ElementId> viewerIds = new FilteredElementCollector(fromView.Document, fromView.Id)
            ...
            //TEMP - Remove the View Tags....
            foreach (ElementId id in viewerIds)
            {
                toCopy.Remove(id);
            }
